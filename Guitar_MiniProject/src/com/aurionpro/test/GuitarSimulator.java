...
public class GuitarSimulator {
	...
	public static void main(String[] args) {
		...
		System.out.println("----- Welcome to the Guitar Simulator -----");
	...
	private static void ownerMode() {
		...
		System.out.println("  - Fender Telecaster (Electric)");
		System.out.println("  - Gibson Les Paul (Electric)");
		System.out.println("  - PRS Custom 24 (Electric)");
		System.out.println("  - Martin D-28 (Acoustic)");
		System.out.println("  - Taylor 814ce (Acoustic)");
		System.out.println("  - Gibson J-45 (Acoustic)");
		System.out.println("  - Guild 12-String (Acoustic)");
	...
	private static Guitar selectGuitar(Scanner sc) {
		...
		case "1":
			...
			System.out.println("3. Fender Telecaster");
			System.out.println("4. PRS Custom 24");
			System.out.print("Enter choice: ");
		...
		case "2":
			...
			System.out.println("3. Gibson J-45");
			System.out.println("4. Guild 12-String");
			System.out.print("Enter choice: ");
			...
			case "3":
				return new GibsonJ45();
			case "4":
				return new Guild12String();
			}
			break;
		}
